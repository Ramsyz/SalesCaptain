export default function Footer() {
  return (
    <footer className="bg-white dark:bg-black pt-4 pb-8 xl:pt-8 text-center text-neutral-600 dark:text-neutral-200 lg:text-left overflow-x-hidden">
      <div className="mx-24 py-10 text-center md:text-left flex justify-center">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="text-sm mx-20">
            <h6 className="mb-2 flex justify-center font-semibold text-gray-500 md:justify-start">
              Products
            </h6>
            <p className="mb-1">
              <a
                href="#!"
                className="text-neutral-600 dark:text-neutral-200 hover:underline"
              >
                Reviews
              </a>
            </p>
          ...
          {/*contact section */}
          <div className="text-sm">
            <h6 className="mb-4 flex justify-center font-semibold  md:justify-start text-gray-500">
              US Headquarters
            </h6>
